...
namespace QuantityMeasurementApp.Tests
{
    public class LengthEqualityTests
    {
        ...
        public void testEquality_InchToInch_SameValue()
        {
            ...
            var l2 = new Length(1.0, LengthUnit.INCHES);
        ...
        {
            var l1 = new Length(1.0, LengthUnit.YARDS);
            var l2 = new Length(36.0, LengthUnit.INCHES);
        ...
        {
            var l1 = new Length(1.0, LengthUnit.CENTIMETERS);
            var l2 = new Length(0.393701, LengthUnit.INCHES);
