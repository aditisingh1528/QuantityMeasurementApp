...
namespace QuantityMeasurementConsoleApp.Menu
{
    public class Menu
    {
        ...
        private QuantityDTO ReadQuantity(string type)
        {
            ...
            // UC17: QuantityDTO now carries MeasurementType so the service can route correctly
            string measurementType = type + "Unit";   // e.g. "Length" → "LengthUnit"
        ...
        private QuantityDTO ReadAnyQuantity()
        {
            ...
            string unit = Console.ReadLine()!;
            Console.Write("Enter measurement type (LengthUnit/WeightUnit/VolumeUnit/TemperatureUnit): ");
